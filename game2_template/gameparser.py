...
def filter_words(words, skip_words):
	...
	for skip_word in skip_words: #Loops through skip_words
		for word in words: #Loops through words
			if word == skip_word: #If a word matches a skipped word then its removed
				words.remove(word)
	return words
...
def remove_punct(text):
    ...
    'goSouTh'
    """
	text = re.sub(r'[^\w\s]','',text) #Using the regex moduel romove any punctuation
	return text
